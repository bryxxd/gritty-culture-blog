...
<template>
  <header class="layout sticky z-50 top-0 px-[10px]">
    <img
      src="~/assets/img/logo-header.png"
      alt="Grain Archive logo"
      class="hidden md:block w-11 h-11 absolute top-0 left-[20px] bottom-0 my-auto"
    />
    <nav>
      <ul
        class="font-semibold text-paragraph-2 text-lg md:text-xl flex gap-2 flex-wrap justify-center py-4"
      >
        <li>
          <NuxtLink
            to="/"
